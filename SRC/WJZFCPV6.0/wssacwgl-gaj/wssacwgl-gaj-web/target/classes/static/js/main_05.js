...
//选项卡初始化
    ...
    $('.I106_subNavList>li').click(function () {
        ...
        if (layHref) {
            ...
            if(layContent=="案件管理") {
                layHref = '/wssacwgl-gaj/Ajjbqk/navigationBar';
            }
   ...
   // $('.H105_clickEvent').live("click",function() {
    ...
    function addTab (content, url) {
        ...
        if ( parent.parent.$('.H105_label').length > 1) {
            parent.parent.$('.H105_labelCoat>.H105_label:eq(1)').replaceWith(' <div class="H105_label H105_label2 fl" lay-href=' + url + ' data-content='+ content +'><span>' + content + '</span><img src="/wssacwgl-gaj/static/images/H105_x1.png" alt="" class="H105_close"></div>');
        } else {
            parent.parent.$('.H105_labelCoat').append(' <div class="H105_label H105_label2 fl" lay-href=' + url+' data-content='+ content +'><span>' + content + '</span><img src="/wssacwgl-gaj/static/images/H105_x1.png" alt="" class="H105_close"></div>');
        }
    }
