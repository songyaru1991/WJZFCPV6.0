...
//选项卡初始化
    ...
    $('.I106_subNavList>li').click(function () {
        ...
        if (layHref) {
            ...
            if(layContent=="看守所_人员基本信息") {
                layContent="人员基本信息";
                layHref = '/wshygl-gaj/Ksry/navigationBarKsryList';
            }
            if(layContent=="看守所_查看换押") {
                layContent="查看换押";
                var searchCondition = $('#searchCondition').val();
                var searchContent = $(" #searchContent").val();
                var pageNo = $(" #pageNo").val();
                layHref = '/wshygl-gaj/Ksshy/navigationBarKsshyList';
            }
            if(layContent==("看守所_换押统计")) {
                layContent="换押统计";
                layHref = "/wshygl-gaj/KssHytj/navigationBarKssHytjList";
            }
            if(layContent==("公安局_网上换押")) {
                layContent="网上换押";
                layHref = "/wshygl-gaj/Gajhy/navigationBarGajhyList";
            }
            if(layContent==("公安局_接收退查")) {
                layContent="接收退查";
                layHref = "/wshygl-gaj/GajJstc/navigationBarGajJstcList";
            }
            if(layContent==("公安局_历史换押记录")) {
                layContent="历史换押记录";
                layHref = "/wshygl-gaj/GajLshyjl/navigationBarGajLshyjlList";
            }
            if(layContent==("公安局_换押信息统计")) {
                layContent="换押信息统计";
                layHref = "/wshygl-gaj/GajHytj/navigationBarGajHytjList";
            }
    ...
    addClickEvent = function (xyrbh) {
        var layContent = '新增';
        var layHref ='/wshygl-gaj/Ksry/toEdit?xyrbh=' + xyrbh
        // 新建或者替换标签
        parentAddTab(layContent, layHref);
        parent.parent.parent.$('.src_iframeleft').attr('src', layHref);
    }
    ...
    function parentAddTab (content, url) {
        ...
        if ( parent.parent.parent.$('.H105_label').length > 1) {
            parent.parent.parent.$('.H105_labelCoat>.H105_label:eq(1)').replaceWith(' <div class="H105_label H105_label2 fl" lay-href=' + url + ' data-content='+ content +'><span>' + content + '</span><img src="/wshygl-gaj/static/images/H105_x1.png" alt="" class="H105_close"></div>');
        } else {
            parent.parent.parent.$('.H105_labelCoat').append(' <div class="H105_label H105_label2 fl" lay-href=' + url+' data-content='+ content +'><span>' + content + '</span><img src="/wshygl-gaj/static/images/H105_x1.png" alt="" class="H105_close"></div>');
        }
    }
    ...
    $('.S105_caseBtn').click(function () {
        ...
        var layHref = $(this).attr('lay-href');
            ...
            +'&czbm='+czbm+'&hybm='+hybm+'&qsrq='+qsrq+'&jsrq='+jsrq;
    ...
    // 看守人员编辑页面的 案件详情按钮点击事件
    S105_caseBtn1ClickEvent = function (layContent,layHref,layFrom,dataformInit,dataformSubmit){

        if(dataformInit==dataformSubmit) {//表单值没有改变直接返回
    ...
    function addTabFrom (content, url,from) {
        ...
        if ( parent.parent.$('.H105_label').length > 1) {
            parent.parent.$('.H105_labelCoat>.H105_label:eq(1)').replaceWith(' <div class="H105_label H105_label2 fl" lay-href=' + url + ' data-content='+ content + ' data-from='+ from +'><span>' + content + '</span><img src="/wshygl-gaj/static/images/H105_x1.png" alt="" class="H105_close"></div>');
        } else {
            parent.parent.$('.H105_labelCoat').append(' <div class="H105_label H105_label2 fl" lay-href=' + url+' data-content='+ content +' data-from='+ from +'><span>' + content + '</span><img src="/wshygl-gaj/static/images/H105_x1.png" alt="" class="H105_close"></div>');
        }
    }
    ...
    $('.H105_labelCoat').on('click', '.H105_label', function () {
        ...
        // 重新加载
      if(layContent.indexOf("人员基本信息")!=-1) {
          layHref = '/wshygl-gaj/Ksry/navigationBarKsryList';
            $('.src_iframeleft').attr('src', layHref);
        }else if(layContent.indexOf("查看换押")!=-1){
          layHref = "/wshygl-gaj/Ksshy/navigationBarKsshyList";
          $('.src_iframeleft').attr('src', layHref);
      }else if(layContent.indexOf("换押统计")!=-1){
          layHref = "/wshygl-gaj/KssHytj/navigationBarKssHytjList";
          $('.src_iframeleft').attr('src', layHref);
      }else if(layContent=="编辑"  || layContent=="新增" || layContent=="查看" || layContent=="案件详情" || layContent=="接收退查" ||layContent=="换押" || layContent=="修改密码"){
          $('.src_iframeleft').attr('src', layHref);
      }else if(layContent=="网上换押"){
          layHref = "/wshygl-gaj/Gajhy/navigationBarGajhyList";
          $('.src_iframeleft').attr('src', layHref);
      }else if(layContent=="历史换押记录"){
          layHref = "/wshygl-gaj/GajLshyjl/navigationBarGajLshyjlList";
          $('.src_iframeleft').attr('src', layHref);
      }else if(layContent=="换押信息统计"){
          layHref = "/wshygl-gaj/GajHytj/navigationBarGajHytjList";
          $('.src_iframeleft').attr('src', layHref);
      }
      else{
    ...
    function addTab (content, url) {
        ...
        // 判断标签个数
        if ( parent.parent.$('.H105_label').length > 1) {
            parent.parent.$('.H105_labelCoat>.H105_label:eq(1)').replaceWith(' <div class="H105_label H105_label2 fl" lay-href=' + url + ' data-content='+ content +'><span>' + content + '</span><img src="/wshygl-gaj/static/images/H105_x1.png" alt="" class="H105_close"></div>');
        } else {
            parent.parent.$('.H105_labelCoat').append(' <div class="H105_label H105_label2 fl" lay-href=' + url+' data-content='+ content +'><span>' + content + '</span><img src="/wshygl-gaj/static/images/H105_x1.png" alt="" class="H105_close"></div>');
        }
    }
