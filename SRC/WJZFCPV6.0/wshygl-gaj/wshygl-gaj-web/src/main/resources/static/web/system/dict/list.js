...
function add() {
    ...
    if(parentCode == '' || parentCode == '-1'){
        ol = layui.layer.open({
            title:'<img src="'+returnUrl('static/images/I208_edit.png')+'"><span>字典类型添加</span>',
            type: 2,
            shadeClose: false,
            shade: 0.6,
            skin:'A106_layer',
        ...
        ol = layui.layer.open({
            title:'<img src="'+returnUrl('static/images/I208_edit.png')+'"><span>字典添加</span>',
            type: 2,
            shadeClose: false,
            shade: 0.6,
            skin:'A106_layer',
...
function edit(){
    ...
    if(type()){
        ol = layui.layer.open({
            title:'<img src="'+returnUrl('static/images/I208_edit.png')+'"><span>字典类型编辑</span>',
            type: 2,
            shadeClose: false,
            shade: 0.6,
            skin:'A106_layer',
        ...
        ol = layui.layer.open({
            title:'<img src="'+returnUrl('static/images/I208_edit.png')+'"><span>字典编辑</span>',
            type: 2,
            shadeClose: false,
            shade: 0.6,
            skin:'A106_layer',
