...
//选项卡初始化
    ...
    $('.I106_subNavList>li').click(function () {
        ...
        if (layHref) {
            ...
            if(layContent=="案件管理") {
                layHref = '/wssacwgl-jcy/Ajjbqk/navigationBar';
            }
    ...
    // 编辑按钮点击事件
   // $('.H105_clickEvent').live("click",function() {
        $('body').on('click', '.H105_clickEvent', function(){
    ...
    $('.H105_labelCoat').on('click', '.H105_label', function () {
        ...
        var layHref = $(this).attr('lay-href');
        // 重新加载
      if(layContent=="案件管理" || layContent=="涉案财物详细" || layContent=="涉案财物增加" || layContent=="修改密码") {
    ...
    function addTab (content, url) {
        ...
        if ( parent.parent.$('.H105_label').length > 1) {
            parent.parent.$('.H105_labelCoat>.H105_label:eq(1)').replaceWith(' <div class="H105_label H105_label2 fl" lay-href=' + url + ' data-content='+ content +'><span>' + content + '</span><img src="/wssacwgl-jcy/static/images/H105_x1.png" alt="" class="H105_close"></div>');
        } else {
            parent.parent.$('.H105_labelCoat').append(' <div class="H105_label H105_label2 fl" lay-href=' + url+' data-content='+ content +'><span>' + content + '</span><img src="/wssacwgl-jcy/static/images/H105_x1.png" alt="" class="H105_close"></div>');
        }
    }
...
// 取消*******删除标签*/
    jq_E105_cannel3ClickEvent = function (layContent,layHref,dataformInit,dataformSubmit) {
