...
var customer = {
    ...
    del: function () {
        ...
        layer.confirm('确定要删除此信息？', {
            ...
            $.ajax({
                type: "delete",
                url: contextPath + "/feedback/" + idList,
                success: function (resp) {
                    if (resp === true) {
                        layer.alert("删除成功");
                        location.href = contextPath + "/feedback/feedbackList";
                    } else {
                        layer.alert("删除失败");
                    }
                }
    ...
    toDetail: function () {
        ...
        layui.layer.open({
            ...
            content: [contextPath + '/feedback/detail/' + id, 'yes']
        });
    },
    toAdd: function () {
        layui.layer.open({
            title: '<img src="' + contextPath + '/images/I208_edit.png"><span>新增反馈</span>',
            type: 2,
            shadeClose: false,
            shade: 0.6,
            skin: 'A106_layer',
            area: ['1000px', '300px'], //宽高
            content: [contextPath + '/feedback/add', 'yes'],
        });
    },
    toEdit: function () {
        var id = customer.getRowFexId("id");
        ...
        layui.layer.open({
            ...
            content: [contextPath + '/feedback/edit/' + id, 'yes']
        });
    },
