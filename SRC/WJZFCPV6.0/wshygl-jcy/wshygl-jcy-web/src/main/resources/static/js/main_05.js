...
//选项卡初始化
    ...
    $('.I106_subNavList>li').click(function () {
        ...
        if (layHref) {
            ...
            if(layContent=="换押人员列表") {
                layHref = '/wshygl-jcy/Ksry/navigationBarKsryList';
            }
            if(layContent=="接收换押") {
                layHref = '/wshygl-jcy/Jshy/navigationBarJshyList';
            }
            if(layContent=="网上换押") {
                layHref = '/wshygl-jcy/Wshy/navigationBarWshyList';
            }
            if(layContent=="历史换押记录") {
                layHref = '/wshygl-jcy/Lshyjl/navigationBarLshyjlList';
            }
            if(layContent==("换押信息统计")) {
                layHref = "/wshygl-jcy/Hytj/navigationBarHytjList";
            }
    ...
    function parentAddTab (content, url) {
        ...
        if ( parent.parent.parent.$('.H105_label').length > 1) {
            parent.parent.parent.$('.H105_labelCoat>.H105_label:eq(1)').replaceWith(' <div class="H105_label H105_label2 fl" lay-href=' + url + ' data-content='+ content +'><span>' + content + '</span><img src="/wshygl-jcy/static/images/H105_x1.png" alt="" class="H105_close"></div>');
        } else {
            parent.parent.parent.$('.H105_labelCoat').append(' <div class="H105_label H105_label2 fl" lay-href=' + url+' data-content='+ content +'><span>' + content + '</span><img src="/wshygl-jcy/static/images/H105_x1.png" alt="" class="H105_close"></div>');
        }
    }
    ...
    $('.S105_caseBtn').click(function () {
        ...
        var layHref = $(this).attr('lay-href');
            ...
            +'&qsrq='+qsrq+'&jsrq='+jsrq+'&isShowAll='+isShowAll;
    ...
    function addTabFrom (content, url,from) {
        ...
        if ( parent.parent.$('.H105_label').length > 1) {
            parent.parent.$('.H105_labelCoat>.H105_label:eq(1)').replaceWith(' <div class="H105_label H105_label2 fl" lay-href=' + url + ' data-content='+ content + ' data-from='+ from +'><span>' + content + '</span><img src="/wshygl-jcy/static/images/H105_x1.png" alt="" class="H105_close"></div>');
        } else {
            parent.parent.$('.H105_labelCoat').append(' <div class="H105_label H105_label2 fl" lay-href=' + url+' data-content='+ content +' data-from='+ from +'><span>' + content + '</span><img src="/wshygl-jcy/static/images/H105_x1.png" alt="" class="H105_close"></div>');
        }
    }
    ...
    $('.H105_labelCoat').on('click', '.H105_label', function () {
      ...
      if(layContent.indexOf("换押人员列表")!=-1 || layContent.indexOf("换押管理")!=-1) {
          ...
          layHref="/wshygl-jcy/Hytj/navigationBarHytjList";
          $('.src_iframeleft').attr('src', layHref);
      }else if(layContent=="接收" || layContent=="查看" || layContent=="换押" || layContent=="延长换押"|| layContent=="上报市院" || layContent=="案件详情" || layContent=="退查" || layContent=="修改密码"){
          $('.src_iframeleft').attr('src', layHref);
      }
      else{
    ...
    function addTab (content, url) {
        ...
        // 判断标签个数
        if ( parent.parent.$('.H105_label').length > 1) {
            parent.parent.$('.H105_labelCoat>.H105_label:eq(1)').replaceWith(' <div class="H105_label H105_label2 fl" lay-href=' + url + ' data-content='+ content +'><span>' + content + '</span><img src="/wshygl-jcy/static/images/H105_x1.png" alt="" class="H105_close"></div>');
        } else {
            parent.parent.$('.H105_labelCoat').append(' <div class="H105_label H105_label2 fl" lay-href=' + url+' data-content='+ content +'><span>' + content + '</span><img src="/wshygl-jcy/static/images/H105_x1.png" alt="" class="H105_close"></div>');
        }
    }
