...
$(document).ready(function () {
    ...
    $.get(contextPath + "/individualism/video/treeJson", function (resp) {
...
var customer = {
    ...
    toDetail: function () {
        ...
        layui.layer.open({
            ...
            content: [contextPath + '/individualism/video/detail/' + id, 'yes']
        });
    },
    toAdd: function () {
        layui.layer.open({
...
function getListByType(type){
    location.href = contextPath + '/individualism/video/all?type=' + type;
}