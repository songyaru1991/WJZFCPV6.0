...
//选项卡初始化
    ...
    $('.I106_subNavList>li').click(function () {
        ...
        if (layHref) {
            ...
            if(layContent==("文书格式设置")) {
                layHref = "/wsgl-sfj/Wsgssz/navigationBarWsgsszList";
            }
            if(layContent==("标签管理")) {
                layHref = "/wsgl-sfj/Bqgl/navigationBarBqglList";
            }if(layContent==("文书管理")) {
                layHref = "/wsgl-sfj/Ajjbqk/navigationBarWsglList";
            }
    ...
    wsglClickEvent = function (layContent,layHref) {
        ...
        parent.parent.$('.H105_labelCoat>.H105_label:eq(0)').replaceWith(' <div class="H105_label H105_label2 fl" lay-href=' + layHref + ' data-content='+ layContent +'><span>' + layContent + '</span><img src="/wsgl-sfj/static/images/H105_x1.png" alt="" class="H105_close"></div>');
    ...
    function parentAddTab (content, url) {
        ...
        if ( parent.parent.parent.$('.H105_label').length > 1) {
            parent.parent.parent.$('.H105_labelCoat>.H105_label:eq(1)').replaceWith(' <div class="H105_label H105_label2 fl" lay-href=' + url + ' data-content='+ content +'><span>' + content + '</span><img src="/wsgl-sfj/static/images/H105_x1.png" alt="" class="H105_close"></div>');
        } else {
            parent.parent.parent.$('.H105_labelCoat').append(' <div class="H105_label H105_label2 fl" lay-href=' + url+' data-content='+ content +'><span>' + content + '</span><img src="/wsgl-sfj/static/images/H105_x1.png" alt="" class="H105_close"></div>');
        }
    }
    ...
    function addTabFrom (content, url,from) {
        ...
        if ( parent.parent.$('.H105_label').length > 1) {
            parent.parent.$('.H105_labelCoat>.H105_label:eq(1)').replaceWith(' <div class="H105_label H105_label2 fl" lay-href=' + url + ' data-content='+ content + ' data-from='+ from +'><span>' + content + '</span><img src="/wsgl-sfj/static/images/H105_x1.png" alt="" class="H105_close"></div>');
        } else {
            parent.parent.$('.H105_labelCoat').append(' <div class="H105_label H105_label2 fl" lay-href=' + url+' data-content='+ content +' data-from='+ from +'><span>' + content + '</span><img src="/wsgl-sfj/static/images/H105_x1.png" alt="" class="H105_close"></div>');
        }
    }
    ...
    $('.H105_labelCoat').on('click', '.H105_label', function () {
        ...
        // 重新加载
     if(layContent=="编辑"  || layContent=="新增" || layContent=="查看" ||layContent=="文书格式设置" || layContent=="判决类别维护"
         || layContent=="文书信息" || layContent=="添加送达回证" || layContent=="修改密码"){
    ...
    function addTab (content, url) {
        ...
        // 判断标签个数
        if ( parent.parent.$('.H105_label').length > 1) {
            parent.parent.$('.H105_labelCoat>.H105_label:eq(1)').replaceWith(' <div class="H105_label H105_label2 fl" lay-href=' + url + ' data-content='+ content +'><span>' + content + '</span><img src="/wsgl-sfj/static/images/H105_x1.png" alt="" class="H105_close"></div>');
        } else {
            parent.parent.$('.H105_labelCoat').append(' <div class="H105_label H105_label2 fl" lay-href=' + url+' data-content='+ content +'><span>' + content + '</span><img src="/wsgl-sfj/static/images/H105_x1.png" alt="" class="H105_close"></div>');
        }
    }
