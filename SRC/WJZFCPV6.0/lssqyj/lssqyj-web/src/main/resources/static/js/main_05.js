...
//选项卡初始化
  ...
  $('.H105_labelCoat').on('click', '.H105_label', function () {
    ...
    if('案件列表'== layContent){
      $('.src_iframeleft').attr('src', '/lssqyj/znjz/navigationBarCaseList');
    }else if('律师授权'== layContent) {
      $('.src_iframeleft').attr('src', '/lssqyj/znjz/navigationBarLssq');
    }else if('人工智能阅卷'== layContent) {
      $('.src_iframeleft').attr('src', '/lssqyj/znyj/navigationBarZnyj');
    }else{
  ...
  function addTab (content, layHref) {
    ...
    if ( parent.parent.$('.H105_label').length > 1) {
      parent.parent.$('.H105_labelCoat>.H105_label:eq(1)').replaceWith(' <div class="H105_label H105_label2 fl" lay-href=' + layHref + ' data-content=' + content + '><span>' + content + '</span><img src="/lssqyj/static/images/H105_x1.png" alt="" class="H105_close"></div>');
    } else {
      parent.parent.$('.H105_labelCoat').append(' <div class="H105_label H105_label2 fl" lay-href=' + layHref + ' data-content=' + content + '><span>' + content + '</span><img src="/lssqyj/static/images/H105_x1.png" alt="" class="H105_close"></div>');
    }
  }
